...
- You can input PC cheats by pressing L+SELECT to open the on-screen keyboard. See https://github.com/TheOfficialFloW/gtasa_vita/CHEATS.md for available and unavailable cheats (you can input cheat codes in lowercase as well as uppercase).
